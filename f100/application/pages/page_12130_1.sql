prompt --application/pages/page_12130
begin
--   Manifest
--     PAGE: 12130
--   Manifest End
...
wwv_flow_imp_page.create_page(
 p_id=>12130
,p_name=>'Configure Application Features'
,p_alias=>'CONFIGURE-APPLICATION-FEATURES'
,p_step_title=>'Configure Application Features'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(18464648391985733385)
,p_plug_name=>'Configure Application Features'
...
'    sp_strategic_proj_util.replace_nomenclature (component_comment)   description,',
...
' and nvl(feature_identifier,''x'') not in ( ''APPLICATION_ACCESS_CONTROL'' /*, ''APPLICATION_CONFIGURATION'' */)',
' order by lower(build_option_name)'))
...
,p_prn_page_header=>'Application Features'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(18464649015748733386)
...
,p_owner=>'MIKE'
,p_internal_uid=>8230594674602228986
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(18464649271039733398)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(18464649685184733400)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(18464650051722733400)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(18464650511642733401)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(18464650924279733401)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(18464651259682733402)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(18464651671061733402)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(21062910729304426611)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(18464654541116733406)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(28243160445430694620)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(20276998694591364195)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(28243160445430694620)
,p_button_name=>'Reset'
...
,p_button_redirect_url=>'f?p=&APP_ID.:12130:&SESSION.::&DEBUG.:RR,12130::'
,p_icon_css_classes=>'fa-undo-alt'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(18464656069867733410)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(20276998395473364193)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(18464656482508733410)
...
'                values (''Updated Feature'', c1.build_option_name ||'' changed to ''||upper(apex_application.g_f03(i)) );',
'        end if;',
'    end loop;',
'end loop;'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Application Features updated. '
,p_internal_uid=>8230602141362229010
);
