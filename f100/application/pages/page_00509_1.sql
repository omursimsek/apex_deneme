...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(145789709083107773550)
,p_plug_name=>'Task'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(145789718446823773556)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(11435456680465892151)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(145789718446823773556)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(11435456335819892151)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(11435455909525892150)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(11435455451917892150)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(11587036080714630830)
,p_name=>'P509_IMPACT'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(145789709083107773550)
,p_item_source_plug_id=>wwv_flow_imp.id(145789709083107773550)
,p_prompt=>'Impact'
,p_source=>'IMPACT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29533735220386787636)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29533735375980787637)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29533735479678787638)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29533735537801787639)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29533735684806787640)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29533735810302787641)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29533735859817787642)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29533735955050787643)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29533736193627787645)
,p_name=>'P509_CREATED'
,p_source_data_type=>'DATE'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(145789709083107773550)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29533736244957787646)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29533736320501787647)
,p_name=>'P509_UPDATED'
,p_source_data_type=>'DATE'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(145789709083107773550)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30747381377039752298)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(42653294104448783483)
,p_name=>'P509_TAGS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(145789709083107773550)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(145789712148982773580)
,p_name=>'P509_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(145789712939026773582)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(11435457418122892152)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(11435457753099892153)
...
,p_associated_item=>wwv_flow_imp.id(29533735810302787641)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(11435458904365892154)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(11435456680465892151)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(11435459405038892154)
,p_event_id=>wwv_flow_imp.id(11435458904365892154)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(11435458132244892153)
...
,p_process_when_button_id=>wwv_flow_imp.id(11435456335819892151)
,p_process_success_message=>'Review deleted.'
,p_internal_uid=>1201403791098387753
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(11435454811842892149)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(145789709083107773550)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(13628148540160228448)
...
'           tt.task_type, t.target_complete, t.impact, t.description,',
...
'    or (:P509_OWNER_ID is not null and :P509_OWNER_ID != :APP_USER_ID and not exists (select 1 from sp_tasks',
'                                                                                       where id = :P509_ID',
'                                                                                         and nvl(owner_id,-1) != :P509_OWNER_ID) )'))
,p_process_when_type=>'EXISTS'
,p_internal_uid=>3394094199013724048
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(11435458468581892153)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(11435254350508892148)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(11587034127201630810)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'log'
