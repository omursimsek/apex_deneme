...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(27140699800134392287)
...
'        values',
'            (:new.init_focus_area_id, ''COMMENT'', ''CREATE'', dbms_lob.substr(:new.body,500,1), :new.body, sysdate, lower(:new.created_by));',
...
'            values',
'                (:new.init_focus_area_id, ''COMMENT'', ''UPDATE'', dbms_lob.substr(:old.body,500,1), dbms_lob.substr(:new.body,500,1), :old.body, :new.body, sysdate, lower(:new.updated_by));',
'        end if;',
'    end if;',
...
'    values',
'        (:old.init_focus_area_id, ''COMMENT'', ''DELETE'', dbms_lob.substr(:old.body,500,1), :old.body, sysdate, lower(coalesce(sys_context(''APEX$SESSION'',''APP_USER''),user)));',
'    end if;',
