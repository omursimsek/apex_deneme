prompt --application/deployment/install/install_projects_tables
begin
--   Manifest
--     INSTALL: INSTALL-projects tables
--   Manifest End
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(12002809102252960281)
,p_install_id=>wwv_flow_imp.id(149557269712237859365)
,p_name=>'projects tables'
,p_sequence=>240
...
'    --',
'    -- determines if project complete is project specific date based or release train based',
'    --',
'    release_dependent_yn           varchar2(1 char) constraint sp_projects_new_release_dep_ck',
'                                   check (release_dependent_yn in (''Y'',''N'')),',
'    --',
...
'    -- external sync',
'    --',
'    external_sync_yn               varchar2(1 char) default on null ''N''',
'                                      constraint sp_projects_ext_sync_cc',
'                                      check (external_sync_yn in (''Y'',''N'')),',
