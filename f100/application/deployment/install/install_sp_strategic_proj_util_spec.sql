prompt --application/deployment/install/install_sp_strategic_proj_util_spec
begin
--   Manifest
--     INSTALL: INSTALL-sp_strategic_proj_util spec
--   Manifest End
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(125069110864754611448)
,p_install_id=>wwv_flow_imp.id(149557269712237859365)
,p_name=>'sp_strategic_proj_util spec'
,p_sequence=>30
,p_script_type=>'INSTALL'
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'create or replace package sp_strategic_proj_util as',
'',
'-- create APIs',
