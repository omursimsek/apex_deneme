...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(41581665911510579593)
...
'    -- defaults',
'    --',
'    if :new.RELEASE_DEPENDENT_YN is null then',
'       if :new.RELEASE is null then',
'           :new.RELEASE_DEPENDENT_YN := ''N'';',
'           :new.RELEASE_ID := null;',
'       else',
'           :new.RELEASE_DEPENDENT_YN := ''Y'';',
'       end if;',
'    end if;',
'',
...
'       :new.friendly_identifier := sp_strategic_proj_util.compress_int(sp_seq.nextval);',
'    end if;',
'    --',
...
'       if not sp_value_compare.is_equal(:old.release_dependent_yn,:new.release_dependent_yn) then',
'          insert into sp_project_history',
'              (project_id, attribute_column, change_type, old_value, new_value, changed_on, changed_by)',
'          values',
'              (:new.id, ''RELEASE_DEPENDENT'', ''UPDATE'', :old.release_dependent_yn, :new.release_dependent_yn, sysdate, l_changed_by);',
'       end if;',
'       -- RELEASE_ID',
...
'       if not sp_value_compare.is_equal(:old.external_sync_yn,:new.external_sync_yn) then',
'          insert into sp_project_history',
'              (project_id, attribute_column, change_type, old_value, new_value, changed_on, changed_by)',
'          values',
'              (:new.id, ''EXTERNAL_SYNC'', ''UPDATE'', :old.external_sync_yn, :new.external_sync_yn, sysdate, l_changed_by);',
'       end if;',
'       if not sp_value_compare.is_equal(:old.sync_identifier,:new.sync_identifier) then',
'          insert into sp_project_history',
'              (project_id, attribute_column, change_type, old_value, new_value, changed_on, changed_by)',
'          values',
'              (:new.id, ''SYNC_IDENTIFIER'', ''UPDATE'', :old.sync_identifier, :new.sync_identifier, sysdate, l_changed_by);',
'       end if;',
'       if not sp_value_compare.is_equal(:old.sync_system_link,:new.sync_system_link) then',
'          insert into sp_project_history',
'              (project_id, attribute_column, change_type, old_value, new_value, changed_on, changed_by)',
'          values',
'              (:new.id, ''SYNC_SYSTEM_LINK'', ''UPDATE'', :old.sync_system_link, :new.sync_system_link, sysdate, l_changed_by);',
'       end if;',
'       if not sp_value_compare.is_equal(:old.last_sync_status,:new.last_sync_status) then',
'          insert into sp_project_history',
'              (project_id, attribute_column, change_type, old_value, new_value, changed_on, changed_by)',
'          values',
'              (:new.id, ''LAST_SYNCED_ON'', ''UPDATE'', to_char(:old.last_synced_on,''DD-MON-YYYY''), to_char(:new.last_synced_on,''DD-MON-YYYY''), sysdate, l_changed_by);',
'          insert into sp_project_history',
'              (project_id, attribute_column, change_type, old_value, new_value, changed_on, changed_by)',
'          values',
'              (:new.id, ''LAST_SYNC_STATUS'', ''UPDATE'', :old.last_sync_status, :new.last_sync_status, sysdate, l_changed_by);',
'       end if;',
'',
'    end if;',
'    ',
