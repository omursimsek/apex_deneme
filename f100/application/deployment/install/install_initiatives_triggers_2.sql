...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(11512081360466665192)
...
'        end if;',
'        if not sp_value_compare.is_equal(:old.primary_url,:new.primary_url) then',
'            insert into sp_initiative_history',
'                (initiative_id, attribute_column, change_type, old_value, new_value,changed_on, changed_by)',
'            values',
'                (:new.id, ''PRIMARY_URL'', ''UPDATE'', :old.primary_url, :new.primary_url, sysdate, l_changed_by);',
'        end if;',
