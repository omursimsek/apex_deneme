prompt --application/deployment/install/install_sp_strategic_proj_util_body
begin
--   Manifest
--     INSTALL: INSTALL-sp_strategic_proj_util body
--   Manifest End
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(125069164690156890536)
,p_install_id=>wwv_flow_imp.id(149557269712237859365)
,p_name=>'sp_strategic_proj_util body'
,p_sequence=>760
,p_script_type=>'INSTALL'
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'create or replace package body sp_strategic_proj_util as',
'',
...
'is ',
'    l_project_id           number;',
'    l_release_dependent_yn varchar2(1) := null;',
'begin',
'    if p_release_id is not null then',
'        l_release_dependent_yn := ''Y'';',
'    elsif p_target_complete is not null then ',
'        l_release_dependent_yn := ''N'';',
'    end if;',
'',
...
'    p_project_id      in number,',
'    p_comment_on      in varchar2 default ''PROJECT'',',
'    P_component_id    in number,',
'    p_private_yn      in varchar2 default ''N'')',
'is',
'    l_team_member_id number;',
'    l_comment_id     number;',
'    l_private_yn     varchar2(1) default p_private_yn;',
'begin',
'    l_team_member_id := get_user_id(p_app_user => p_app_user);',
'    if l_private_yn is null then ',
'       l_private_yn := ''N'';',
'    end if;',
'    --',
'    --',
...
'        l_team_member_id,',
'        p_comment,',
'        nvl(upper(p_comment_on),''PROJECT''),',
'        p_component_id,',
'        l_private_yn)',
...
'',
'procedure unmark_proj_as_duplidate (',
'    p_project_id        in number)',
'is ',
'begin',
'    update sp_projects set DUPLICATE_OF_PROJECT_ID = null where id = p_project_id;',
'end unmark_proj_as_duplidate;',
'',
'------------------------',
'-- string function APIs',
'------------------------',
'',
...
'    l_app_id := sp_strategic_proj_util.get_setting(p_static_id => ''APP_ID'');',
'',
...
'    then',
'',
'        l_app_url       := sp_strategic_proj_util.get_setting(p_static_id => ''APP_HOME_URL'');',
'        l_project_label := sp_strategic_proj_util.get_nomenclature(''PROJECT'');',
'        l_app_name      := sp_strategic_proj_util.get_nomenclature(''STRATEGIC_PLANNER'');',
'        l_gen_date      := to_char(l_sysdate,''DD-Mon-YYYY'');',
'        l_opt_out_url   := sp_strategic_proj_util.get_setting(p_static_id => ''APP_PREFIX_URL'')||',
'                               apex_page.get_url(',
...
'            (team_member_id, project_id, title, email_contents, notification_pref)',
'        values',
'            (p_team_member_id, p_project_id, p_title, p_email_contents, c1.notification_pref);',
'',
...
'                p_placeholders       => ''{'' || ''"PROJECT_LINK": "'' || p_project_link ||''", ''|| ',
...
'            (team_member_id, project_id, title, email_contents, notification_pref)',
'        values',
'            (p_team_member_id, p_project_id, p_title, p_email_contents, c1.comment_pref);',
'',
